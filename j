...
local Window = Library.CreateLib("web's script hub", "DarkTheme")
local Tab = Window:NewTab(":)")
local Section = Tab:NewSection("stuff")

Section:NewButton("fly", "fly like a bird (press e)", function()
    repeat wait() 
...
Fly()
 ...
 Section:NewButton("da hood ban script", "click to get banned on da hood", function()
...
Section:NewButton("noclip", "clip through walls", function()
...
Section:NewButton("swag mode for da hood", "swagmode", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/lerkermer/lua-projects/master/SwagModeV002'))()

end)
Section:NewButton("Owlhub Aimbot", "good for arsenal", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/CriShoux/OwlHub/master/OwlHub.txt"))();

end)
Section:NewButton("boombox visualizer (Pineapple hub)", "name says all", function()
